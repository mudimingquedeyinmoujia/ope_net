...
test_config_list = [
    ...
    #---------------
    # 'test_CIR-SR-b100-x2-ud.yaml',
    # 'test_CIR-SR-b100-x3-ud.yaml',
    # 'test_CIR-SR-b100-x4-ud.yaml',
    # 'test_CIR-SR-div2k-x2-ud.yaml',
    # 'test_CIR-SR-div2k-x3-ud.yaml',
    # 'test_CIR-SR-div2k-x4-ud.yaml',
    'test_CIR-SR-set14-x2-ud.yaml',
    'test_CIR-SR-set14-x3-ud.yaml',
    'test_CIR-SR-set14-x4-ud.yaml',
    'test_CIR-SR-set5-x2-ud.yaml',
    'test_CIR-SR-set5-x3-ud.yaml',
    'test_CIR-SR-set5-x4-ud.yaml',
    # 'test_CIR-SR-urban100-x2-ud.yaml',
    # 'test_CIR-SR-urban100-x3-ud.yaml',
    # 'test_CIR-SR-urban100-x4-ud.yaml',
]
