...
def main(config_, save_path, args):
    ...
    if args.gt_path is not None:
        ...
        img_gt = None
    gpu_tracker.track()
    sr_img, psnr, ssim, run_time = single_img_sr(img_lr, model, h=args.h, w=args.w, gt=img_gt, flip=args.flip)
    gpu_tracker.track()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_path', default='test_imgs/div2k_test/0880x4.png')
    ...
    if args.flip is not None:
        config['model']['name'] = 'OPE-net-flip'
        sub_save_folder = 'SISR_folder_flip/' + ckpt_name_ \
                          + f'/flip_{args.flip[0]}{args.flip[1]}{args.flip[2]}{args.flip[3]}'
